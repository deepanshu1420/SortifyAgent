...
![ESLint](https://img.shields.io/badge/ESLint%20%7C%20Linting-800000?style=flat&logo=eslint&logoColor=white)<br>
...
```bash
git clone https://github.com/deepanshu1420/SortifyAgent.git
```
...
### 5️⃣ Open the local URL shown below in your browser - use `Chrome` or `Edge`
```bash
http://localhost:5173
```
